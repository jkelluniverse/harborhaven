...
export default async function MoneyPage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Link href="/app/invoices" className="flex min-h-12 items-center justify-center rounded-xl border border-teal-800 px-5 text-lg font-semibold text-teal-800">
        All invoices
      </Link>
